...
description: 使用Commerce Intelligence 2.0报表API查看Analytics从Adobe Analytics导入的数据字段，以便您了解报表中需要执行的操作。
...
| `Empty component combinations` | 某些量度和维度组合不包含数据。 如果选择了此类组合进行复制，[!DNL Commerce Intelligence]会从复制表中排除该列。 要避免选择此类组合，您可以首先在[[!DNL Adobe Analytics] Workspace](https://experienceleague.adobe.com/zh-hans/docs/analytics/analyze/analysis-workspace/home)中创建报告，以验证您是否获得了预期的数据。 |
