...
开始之前，[提交支持票证](https://experienceleague.adobe.com/zh-hans/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies)以将以下维度联接到行项目表(`sales\_flat\_order\_item, order\_item`)：
