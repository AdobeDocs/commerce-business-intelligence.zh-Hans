...
只有在新架构上具有[!DNL Adobe Commerce Intelligence] Pro计划时（例如，如果在`Manage Data`菜单下具有`Data Warehouse Views`选项），才能配置RFM分析。 可从&#x200B;**[!DNL Manage Data > Data Warehouse]**&#x200B;页面创建这些列。 下面提供了详细说明。
