...
了解业务的优惠券表现对于细分您的订单以及更好地了解您的客户非常有趣。 本文将引导您完成创建分析的步骤，以了解您通过使用优惠券获得哪些客户、它们如何执行和跟踪一般优惠券使用情况。
...
第一步，您需要确保将以下列同步到Data warehouse。 如果不是，请导航到“管理数据”>“Data warehouse”并同步以下内容，以继续跟踪他们：
