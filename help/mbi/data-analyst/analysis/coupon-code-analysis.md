---
title: 优惠券效果
description: 在Commerce Intelligence中分析优惠券性能。 按优惠券代码对订单进行分段，以查看哪些优惠券会推动客户获取、跟踪使用情况并衡量结果。
...
![分析库中的优惠券代码分析显示关键量度](../../assets/coupon_analysis_-_analysis_library.png)<!--{: width="800" height="375"}-->
