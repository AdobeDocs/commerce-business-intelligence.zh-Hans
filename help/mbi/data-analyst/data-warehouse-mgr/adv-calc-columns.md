...
要定义新的计算列，请[提交支持票证](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies)，其中包含有关要生成的项目的详细信息。
