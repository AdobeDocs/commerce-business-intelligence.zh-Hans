...
| **代替此……** | **尝试此操作！** |
|-----|-----|
| 使用SELECT星号](../../mbi/assets/Select_all_1.png)的![SQL查询 | ![选择特定列的SQL查询](../../mbi/assets/Select_all_2.png) |
...
| **代替此……** | **尝试此操作！** |
|-----|-----|
| ![SQL查询，在筛选前GROUP BY ](../../mbi/assets/Group_by_2.png) | 在GROUP BY](../../mbi/assets/Group_by_1.png)之前使用筛选器的![SQL查询 |
